...
final case class SampleArrayMsg(
    ...
    def companion: Network.Network.SampleArrayMsg.type = Network.Network.SampleArrayMsg
    // @@protoc_insertion_point(GeneratedMessage[Network.SampleArrayMsg])
}

object SampleArrayMsg extends scalapb.GeneratedMessageCompanion[Network.Network.SampleArrayMsg] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[Network.Network.SampleArrayMsg] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): Network.Network.SampleArrayMsg = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[Network.Network.SampleArrayMsg] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = Network.Network.SampleArrayMsg(
    serializedsample = _root_.com.google.protobuf.ByteString.EMPTY
  )
  implicit class SampleArrayMsgLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, Network.Network.SampleArrayMsg]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, Network.Network.SampleArrayMsg](_l) {
  ...
  ): _root_.Network.Network.SampleArrayMsg = _root_.Network.Network.SampleArrayMsg(
    serializedsample
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[Network.SampleArrayMsg])
}
